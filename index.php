...
<html lang="en">
  ...
  <body class="landing-page">
      ...
      <div class="landing-home">
        ...
        <div class="container-fluid">
          <div class="sticky-header">
            <header>                       
              <nav class="navbar navbar-b navbar-trans navbar-expand-xl fixed-top nav-padding" id="sidebar-menu"><a class="navbar-brand p-0" href="#"><img class="img-fluid" src="../assets/images/logo/nova.png" alt=""></a>
              </nav>
            </header>
          </div>
          <div class="row">
            <div class="col-xl-5 col-lg-6">
              <div class="content">
                <div>
                  <h1 class="wow pulse">Novatify </h1>
            ...
            <div class="col-xl-7 col-lg-6">                 
              <div class="wow fadeIn"><img class="screen1" src="../assets/images/dashboard/preview.PNG" width="781px" alt=""></div>
              <div class="wow fadeIn"><img class="screen2" src="../assets/images/dashboard/preview2.PNG" width="750px" alt=""></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <nav class="navbar fixed-bottom">
      <div class="container-fluid">
        <button class="btn btn-green bottom-fixed"><img src="../assets/images/logo/send.png" style="width: 3.75rem"></button>
        <p class="result"></p>
      </div>
    </nav>
    ...
    <script>
      const shareData = {
          title: 'Novatify',
          text: 'Novatify FinTech Solution',
          url: 'index.html'
        }
        ...
        btn.addEventListener('click', async () => {
          try {
            ...
            resultPara.textContent = 'Novatify shared successfully'
          } catch (err) {
